                    ...
                    <div className="flex items-center gap-3 mb-2">
                        <div className="relative overflow-hidden rounded-lg">
                            {settings?.logoBase64 ? (
                                ...
                                <img src={logo} alt="Monteiro Corretora" className="h-12 w-auto object-contain" />
                            )}
                        </div>
            ...
            <div className="flex-1 flex items-center justify-center p-8 bg-slate-50">
                <div className="w-full max-w-[420px]">
                    ...
                    <div className="lg:hidden flex items-center gap-3 mb-10">
                        <div className="relative overflow-hidden rounded-lg">
                            {settings?.logoBase64 ? (
                                <img src={settings.logoBase64} alt={settings.siteName} className="h-10 w-auto object-contain" />
                            ) : (
                                <img src={logo} alt="Monteiro Corretora" className="h-10 w-auto object-contain" />
                            )}
                        </div>
                        <div className="flex flex-col font-display leading-tight">
