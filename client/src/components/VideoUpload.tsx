...
import { Video, X, UploadCloud, CheckCircle2 } from "lucide-react";
...
export function VideoUpload({ value, onChange, label, description }: VideoUploadProps) {
                ...
                {preview ? (
                    <div className="relative w-full h-full flex flex-col items-center">
                        <video
                            src={preview}
                            controls
                            className="max-h-[200px] rounded-lg shadow-sm mb-4"
                        />
                        <div className="flex items-center gap-2">
                            <span className="text-xs font-medium text-primary flex items-center gap-1">
                                <CheckCircle2 className="h-3 w-3" /> Vídeo selecionado
                            </span>
                            <Button
                                variant="ghost"
                                size="sm"
