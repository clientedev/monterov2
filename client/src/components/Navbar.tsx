  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? (location === "/blog" ? "bg-slate-900/95 backdrop-blur-md shadow-sm py-1 border-b border-white/10" : "bg-white/95 backdrop-blur-md shadow-sm py-1")
          : (location === "/blog" ? "bg-slate-900 py-2 border-b border-white/10" : "bg-transparent py-2")
      )}
    >
