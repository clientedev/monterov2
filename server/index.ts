...
(async () => {
  ...
  const startupQueries = [
    ...
    `ALTER TABLE clientes ADD COLUMN IF NOT EXISTS contact_id integer REFERENCES contacts(id)`,
    `ALTER TABLE clientes ADD COLUMN IF NOT EXISTS type text NOT NULL DEFAULT 'individual'`,
    `ALTER TABLE clientes ADD COLUMN IF NOT EXISTS anniversary_date text`,
    `ALTER TABLE clientes ADD COLUMN IF NOT EXISTS product_type text`,
    `ALTER TABLE clientes ADD COLUMN IF NOT EXISTS insurers text`,
    `ALTER TABLE clientes ADD COLUMN IF NOT EXISTS contact_origin text`,
    `ALTER TABLE clientes ADD COLUMN IF NOT EXISTS is_referral boolean DEFAULT false NOT NULL`,
    `ALTER TABLE clientes ADD COLUMN IF NOT EXISTS referred_by_contact_id integer`,
    `ALTER TABLE clientes ADD COLUMN IF NOT EXISTS internal_responsible_id integer REFERENCES users(id)`,
    `ALTER TABLE contacts ADD COLUMN IF NOT EXISTS internal_responsible_id integer REFERENCES users(id)`,
    `ALTER TABLE contacts ADD COLUMN IF NOT EXISTS insurers text`,
    `ALTER TABLE contacts ADD COLUMN IF NOT EXISTS contact_origin text`,
    `ALTER TABLE contacts ADD COLUMN IF NOT EXISTS is_referral boolean DEFAULT false NOT NULL`,
    `ALTER TABLE contacts ADD COLUMN IF NOT EXISTS referred_by_contact_id integer`,
